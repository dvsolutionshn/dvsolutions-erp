...
from .vincular_proveedores import vincular_libro
...
urlpatterns = [
    path('libro-compras/clientes/<int:cliente_id>/libros/<int:anio>/<int:mes>/proveedores/', vincular_libro, name='vincular_proveedores_libro'),
    ...
    path('productos/codigos-barras/', views.codigos_barras_productos, name='codigos_barras_productos'),
    ...
    path('productos/<int:producto_id>/eliminar/', views.eliminar_producto, name='eliminar_producto_facturacion'),
    ...
    path('inventario/bodegas/', views.bodegas_dashboard, name='bodegas_dashboard'),
    path('inventario/bodegas/<int:bodega_id>/', views.ver_bodega_inventario, name='ver_bodega_inventario'),
    ...
    path('inventario/regalias/', views.regalias_inventario, name='regalias_inventario'),
    path('inventario/regalias/productos/', views.regalias_buscar_productos, name='regalias_buscar_productos'),
    ...
    path('inventario/compras/proveedores/crear-rapido/', views.compra_crear_proveedor_rapido, name='compra_crear_proveedor_rapido'),
    path('inventario/compras/productos/crear-rapido/', views.compra_crear_producto_rapido, name='compra_crear_producto_rapido'),
    ...
    path('comisiones/<int:pago_factura_id>/pagar/', views.registrar_pago_comision_proveedor, name='registrar_pago_comision_proveedor'),
    path('comisiones/<int:pago_factura_id>/pagos/<int:pago_id>/revertir/', views.revertir_pago_comision_proveedor, name='revertir_pago_comision_proveedor'),
    ...
    path('<int:factura_id>/pdf/ejecutiva-amkt/', views.descargar_factura_pdf_ejecutiva_amkt, name='descargar_factura_pdf_ejecutiva_amkt'),
    ...
    path('<int:factura_id>/pdf/ejecutiva-amkt/vista-previa/', views.vista_previa_factura_pdf_ejecutiva_amkt, name='vista_previa_factura_pdf_ejecutiva_amkt'),
