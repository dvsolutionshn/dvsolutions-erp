...
urlpatterns = [
    ...
    path("agenda/", views.agenda, name="tecnicentro_agenda"),
    path("agenda/<int:cita_id>/estado/", views.cambiar_estado_cita, name="tecnicentro_cita_estado"),
    ...
    path("recepcion/<int:orden_id>/inspeccion/", views.inspeccion_recepcion, name="tecnicentro_inspeccion"),
