...
urlpatterns = [
    ...
    path("disponibilidad/bloquear/", views.guardar_bloqueo_disponibilidad, name="agenda_bloqueo_guardar"),
    path("disponibilidad/<int:bloqueo_id>/eliminar/", views.eliminar_bloqueo_disponibilidad, name="agenda_bloqueo_eliminar"),
