...
class UsuarioControlCreateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        textos = {
            ...
            "modo_clinico_simple": ("Modo clinico simple", "Oculta los modulos administrativos y deja una bienvenida directa a Clinica y Facturacion."),
...
class UsuarioControlUpdateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        textos = {
            ...
            "modo_clinico_simple": ("Modo clinico simple", "Ideal para doctoras: muestra solo Clinica, pacientes y Facturacion en la pantalla principal."),
...
class RolSistemaForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        textos = {
            ...
            "puede_clinica": ("Acceso general a Clinica", "Autoriza entrar al panel clinico y a la operacion de citas clinicas."),
            "puede_pacientes": ("Gestionar pacientes", "Autoriza consultar y administrar el directorio de pacientes."),
            "puede_expediente_clinico": ("Gestionar expedientes clinicos", "Autoriza consultar y registrar informacion del expediente medico."),
            "puede_tratamientos_clinicos": ("Gestionar tratamientos clinicos", "Autoriza crear y dar seguimiento a planes de tratamiento."),
            "puede_configuracion_clinica": ("Configurar Clinica", "Autoriza administrar doctores, profesionales y tipos de consulta."),
