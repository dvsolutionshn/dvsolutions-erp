...
def erp_access(request):
    ...
    base = {
        ...
        "crear_facturas": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_crear_facturas"),
        "editar_facturas": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_editar_facturas"),
        "anular_facturas": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_anular_facturas"),
        "eliminar_borradores": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_eliminar_borradores"),
        "eliminar_facturas": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_eliminar_facturas"),
        "registrar_pagos_clientes": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_registrar_pagos_clientes"),
        "crear_clientes": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_crear_clientes"),
        "editar_clientes": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_editar_clientes"),
        "crear_productos": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_crear_productos"),
        "editar_productos": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_editar_productos"),
        "crear_proveedores": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_crear_proveedores"),
        "editar_proveedores": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_editar_proveedores"),
        "ajustar_inventario": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_ajustar_inventario"),
        "crear_compras": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_crear_compras"),
        "editar_compras": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_editar_compras"),
        "aplicar_compras": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_aplicar_compras"),
        "anular_compras": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_anular_compras"),
        "registrar_pagos_proveedores": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_registrar_pagos_proveedores"),
        "crear_notas_credito": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_crear_notas_credito"),
        "editar_notas_credito": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_editar_notas_credito"),
        "anular_notas_credito": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_anular_notas_credito"),
        "exportar_reportes": getattr(user, "tiene_permiso_erp", lambda *_: False)("puede_exportar_reportes"),
