          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  const Text('Onix', style: TextStyle(fontSize: 19, fontWeight: FontWeight.w800)),
                  Row(
                    children: [
                      const SizedBox(
                        width: 7,
                        height: 7,
                        child: DecoratedBox(
                          decoration: BoxDecoration(color: onixCyan, shape: BoxShape.circle),
                        ),
                      ),
                      ...
                      Flexible(
                        child: Text(
                          ...
                          style: TextStyle(fontSize: 12, color: Colors.white.withValues(alpha: .66)),
                        ),
                      ),
                    ],
                  ),
          ...
          children: [
              ...
              onSelected: (category) {
                if (category.available) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('${category.title} sera conectado en la siguiente etapa.')),
                  );
                }
              },
            ),
            if (widget.controller.error != null)
              MaterialBanner(
                ...
                actions: [
                  TextButton(onPressed: widget.controller.clearError, child: const Text('Cerrar')),
                ],
              ),
            Expanded(
              child: widget.controller.messages.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemCount: widget.controller.messages.length + (widget.controller.sending ? 1 : 0),
                      itemBuilder: (context, index) {
                        ...
                        return _MessageBubble(
                          ...
                          onDecision: (action, decision) async {
                            final ok = await widget.controller.decide(action, decision);
            ...
            return ActionChip(
              ...
              label: Column(
                ...
                children: [
                  ...
                  if (!category.available)
                    const Text('Proximamente', style: TextStyle(fontSize: 9, color: Color(0xFF7C6FE7))),
                ],
              ),
              side: BorderSide(color: category.available ? const Color(0xFFCCE3E4) : const Color(0xFFE3DFFD)),
              backgroundColor: category.available ? const Color(0xFFF1FAFA) : const Color(0xFFF8F6FF),
        ...
        child: Column(
          children: [
            ...
            Text(
              ...
              style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: onixInk, height: 1.25),
            ),
            ...
            _QuickPrompt(text: 'Que clientes tienen saldos pendientes', onTap: onPrompt),
          ],
        ),
      );
}
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  const Icon(Icons.auto_awesome_rounded, color: Color(0xFF087E82), size: 20),
                  const SizedBox(width: 12),
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(child: Text(action.title, style: const TextStyle(fontWeight: FontWeight.w800))),
              _ActionStatus(status: action.status),
            ],
          ),
          if (action.description.isNotEmpty) ...[
            const SizedBox(height: 8),
            Text(action.description, style: const TextStyle(color: Color(0xFF4C6670))),
          ],
          if (action.clientName.isNotEmpty) ...[
            const SizedBox(height: 14),
            Text('Cliente: ${action.clientName}', style: const TextStyle(fontWeight: FontWeight.w700)),
          ],
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(fontSize: 19, fontWeight: FontWeight.w900, color: onixInk),
                ),
              ],
            ),
          ],
              ...
              DecoratedBox(
                ...
                child: Padding(
                  ...
                  child: SizedBox(
                    width: 18,
                    height: 18,
                    child: CircularProgressIndicator(strokeWidth: 2, color: Color(0xFF087E82)),
                  ),
                ),
              ),
            ],
          ...
          children: [
            IconButton(
              onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Archivos y estados de cuenta se conectaran en la siguiente etapa.')),
              ),
              tooltip: 'Adjuntar',
            ...
            IconButton.filled(
              ...
              tooltip: 'Enviar',
              style: IconButton.styleFrom(backgroundColor: const Color(0xFF087E82), foregroundColor: Colors.white),
