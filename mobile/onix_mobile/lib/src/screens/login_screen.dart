...
class _LoginScreenState extends State<LoginScreen> {
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(color: Colors.white.withValues(alpha: .66), fontSize: 15),
                    ),
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            const Text(
                              'Entra a tu espacio',
                              style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: onixInk),
                            ),
                            const SizedBox(height: 6),
                            const Text('Usa los mismos accesos de tu empresa en el ERP.'),
                            ...
                            const SizedBox(height: 20),
                            FilledButton.icon(
                              onPressed: widget.controller.authenticating ? null : _submit,
                              ...
                              label: Text(widget.controller.authenticating ? 'Conectando...' : 'Entrar a Onix'),
                            ),
                          ],
                        ),
                      ),
  ...
  String? _required(String? value) => (value ?? '').trim().isEmpty ? 'Este campo es obligatorio.' : null;
}
